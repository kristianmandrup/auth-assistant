...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".DS_Store",
     ...
     "lib/.DS_Store",
     "lib/PERMITS.txt",
     "lib/ROLE_STRATEGIES.txt",
     "lib/VIEW_HELPERS.txt",
     ...
     "lib/generators/auth_assist/clear/CLEAR_GENERATOR.txt",
     "lib/generators/auth_assist/clear/clear_generator.rb",
     "lib/generators/auth_assist/config/.DS_Store",
     "lib/generators/auth_assist/config/CONFIG_GENERATOR.txt",
     ...
     "lib/generators/auth_assist/views/VIEWS_GENERATOR.txt",
